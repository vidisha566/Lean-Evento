...
<body>
	<div id="wrapper">
			...
			<div align="right"><button type="button" style="background-color: green; width: 10%; border-radius: 30px;"><a href="addevent.php" style="color: white;"> Agregar </a> </button></div>
			<?php
			...
			<?php
				...
				echo"<td><input type=text name=details value='".$row['DETALLES DEL EVENTOS']."'></td>";
				echo"<td><input type=text name=place value='".$row['LUGAR']."'></td>";
				echo"<td><input type=text name=date value='".$row['FECHA']."'></td>";
