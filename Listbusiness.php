...
<body>
	<div id="wrapper">
			...
			<table>
				...
				<tr>
					<td><img src="images/user.png" height="12%" width="10%">Nombre de la Fundacion</td>
					<td>Nombre del Eventos</td>
					<td>Nombre del Responsable </td>
					<td></td>
					<td><button type="button" style="border-radius: 30px;"> Asignar </button></td>
				</tr>
				<tr>
					<td><img src="images/user.png" height="12%" width="10%">Nombre del Voluntario</td>
					<td>Nombre del Eventos</td>
					<td>Nombre del Responsable</td>
					<td></td>
					<td><button type="button" style="border-radius: 30px;"> Asignar </button></td>
